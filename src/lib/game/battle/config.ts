...
export const STAT_PROFILE: Record<string, StatProfile> = {
  // ---- comuns ----
  mosslet: { hp: 2.31, atk: 0.82, def: 1.12 },
  pebbly: { hp: 2.21, atk: 0.85, def: 1.35 },
  drippet: { hp: 2.0, atk: 0.95, def: 0.95 },
  sparkid: { hp: 1.6, atk: 1.28, def: 0.8 },
  frostnib: { hp: 2.5, atk: 1.05, def: 1.0 },
  vinelet: { hp: 2.17, atk: 0.9, def: 1.05 },
  twiglin: { hp: 1.9, atk: 1.0, def: 0.95 },
  sandpip: { hp: 1.7, atk: 1.12, def: 0.85 },
  cragling: { hp: 2.44, atk: 0.9, def: 1.4 },
  toxlet: { hp: 1.9, atk: 1.1, def: 0.9 },
  ferrik: { hp: 2.0, atk: 0.95, def: 1.38 },
  // ---- incomuns ----
  thornhop: { hp: 1.75, atk: 1.2, def: 0.9 },
  tidewhisk: { hp: 2.02, atk: 1.0, def: 0.98 },
  cindertail: { hp: 1.8, atk: 1.22, def: 0.85 },
  glaciva: { hp: 2.4, atk: 0.88, def: 1.22 },
  dunecoil: { hp: 2.0, atk: 1.05, def: 1.0 },
  lumibug: { hp: 1.6, atk: 1.15, def: 0.85 },
  mistmote: { hp: 1.7, atk: 1.05, def: 0.95 },
  glowfin: { hp: 1.9, atk: 1.08, def: 0.92 },
  zephyx: { hp: 1.64, atk: 1.18, def: 0.85 },
  // ---- raros ----
  ashmole: { hp: 2.3, atk: 0.95, def: 1.28 },
  emberfang: { hp: 1.77, atk: 1.35, def: 0.88 },
  moonfang: { hp: 1.9, atk: 1.3, def: 0.9 },
  abyssquill: { hp: 2.0, atk: 1.12, def: 0.95 },
  barkgolem: { hp: 2.9, atk: 0.82, def: 1.5 },
  mirasand: { hp: 1.8, atk: 1.18, def: 0.88 },
  petalynx: { hp: 1.7, atk: 1.28, def: 0.85 },
  quartzox: { hp: 2.24, atk: 0.88, def: 1.45 },
  bloomserp: { hp: 2.1, atk: 1.08, def: 0.98 },
  starkit: { hp: 1.64, atk: 1.22, def: 0.88 },
  gustwing: { hp: 1.9, atk: 1.3, def: 0.82 },
  ...
  voltyx: { hp: 1.6, atk: 1.42, def: 0.82 },
  venomyra: { hp: 1.8, atk: 1.32, def: 0.9 },
  chromaw: { hp: 1.84, atk: 1.2, def: 1.25 },
  // ---- épicos ----
  ...
  gaiaruk: { hp: 3.0, atk: 1.0, def: 1.45 },
  aeromyr: { hp: 1.76, atk: 1.25, def: 0.95 },
  // ---- lendários ----
  solmyrr: { hp: 2.24, atk: 1.3, def: 1.05 },
  nebulith: { hp: 3.06, atk: 0.82, def: 1.2 }, // baleia: muita vida, pouco dano
  thundrix: { hp: 1.8, atk: 1.4, def: 0.92 },
  seraphae: { hp: 2.08, atk: 1.05, def: 1.15 },
  chronavyr: { hp: 2.0, atk: 1.18, def: 1.05 },
  titanox: { hp: 2.68, atk: 1.05, def: 1.55 },
  // ---- míticos ----
  eclipsaur: { hp: 2.7, atk: 1.1, def: 1.3 },
  arcanyx: { hp: 2.85, atk: 1.38, def: 0.95 },
  abyssaria: { hp: 2.9, atk: 1.0, def: 1.18 },
  umbraleth: { hp: 1.9, atk: 1.4, def: 0.9 },
  malachor: { hp: 2.0, atk: 1.35, def: 1.0 },
  // ---- divinos ----
  astraeon: { hp: 2.5, atk: 1.2, def: 1.25 },
  equinoxis: { hp: 2.4, atk: 1.05, def: 1.2 },
  luminara: { hp: 2.2, atk: 1.15, def: 1.15 },
  // ---- secreto ----
  aetheryon: { hp: 2.4, atk: 1.35, def: 1.15 },
};
